from sympy import Function, Eq, symbols, simplify, diff, dsolve
from sympy.solvers.ode.systems import dsolve_system

'''
We may assume that the radius of the target is 1 and that the distance
of the arrow to the center has a uniform distribution.
